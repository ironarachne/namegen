...
var (
	germanFirstNames = []string{
		...
		"Gabriel", "Georg", "Gerald", "Gerold", "Gerhard", "Gernot", "Gregor", "Günther",
		"Hans", "Hannes", "Harald", "Helmut", "Herbert",
	...
	germanLastNames = []string{
		...
		"Ofner", "Ortner", "Oswald", "Ott", "Oberhofen",
		"Paar", "Pacher", "Pagendarm", "Pammer", "Paul", "Payer", "Peer", "Penz", "Peter", "Petrovic", "Petz", "Pfaff", "Pfeffer", "Pfeifer", "Pfeiffer", "Pfister", "Pfleger", "Pichler", "Pilz", "Pinter", "Pirker", "Plank", "Plattner", "Platzer", "Pointner", "Pokorny", "Pollak", "Posch", "Prem", "Prinz", "Probst", "Pucher", "Putz", "Pöll", "Pölzl", "Pöschl", "Pühringer",
